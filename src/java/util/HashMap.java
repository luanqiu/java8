...
public class HashMap<K,V> extends AbstractMap<K,V>
   ...
   //容量最小64时才会转会成红黑树
    ...
    static final class TreeNode<K,V> extends LinkedHashMap.Entry<K,V> {
        ...
        //1：从根节点递归查找
        //2：判断当前节点是否就是要找的节点，是的话递归结束
        //3：根据hashcode快速定位到是大于(右边子节点继续递归)当前节点还是小于(左边子节点继续递归)，重复2
    ...
    //扩容是双倍扩容，要么还在原来索引位置
    // 要么movewith a power of two offset in the new table(不知道如何翻译)
